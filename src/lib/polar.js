...
export const PLANS = {
  free: {
    ...
    limits: {
      dailyGenerations: 5,
      allowedModels: ['gemini-2.0-flash', 'fal-grok', 'fal-ideogram-v3', 'hybrid-flux2-edit', 'hybrid-seedream-edit', 'hybrid-kontext'],
      allowedArchetypes: ['shocked_threat', 'power_fantasy', 'before_after', 'reaction_face', 'expert_authority', 'challenge_fun'],
      allowedTypoStyles: ['auto_harmony', 'bold_impact'],
      maxResolution: '720p',
      watermark: true,
      conceptImage: false,
      topicResearch: false,
  ...
  pro: {
    ...
    limits: {
      ...
      allowedTypoStyles: ['auto_harmony', 'cinematic_epic', 'gaming_neon', 'bold_impact', 'elegant_modern', 'comic_action', 'simple_brush'],
      maxResolution: '4k',
      watermark: false,
      conceptImage: true,
      topicResearch: true,
